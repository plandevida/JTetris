...
public class EleI extends Pieza {
	...
	protected void crearForma() {
		...
		forma[0][0] = null; 										forma[0][1] = new Cubito(1*lado, 0*lado, color, this); 		forma[0][2] = null;
		forma[1][0] = null; 										forma[1][1] = new Cubito(1*lado, 1*lado, color, this); 		forma[1][2] = null;
