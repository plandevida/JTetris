...
public class EscalonI extends Pieza {
	...
	protected void crearForma() {
		...
		forma[0][0] = null; 										forma[0][1] = new Cubito(x+1*lado, y+0*lado, color, this); 	forma[0][2] = new Cubito(x+2*lado, y+0*lado, color, this);
		forma[1][0] = new Cubito(x+0*lado, y+1*lado, color, this); 	forma[1][1] = new Cubito(x+1*lado, y+1*lado, color, this); 	forma[1][2] = null;
